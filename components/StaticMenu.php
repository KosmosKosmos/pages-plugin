        ...
        Event::listen('pages.menu.referencesGenerated', function (&$items) {
            ...
            $iterator = function ($menuItems) use (&$iterator, $user) {
                ...
                foreach ($menuItems as $item) {
                    $loggedIn = !isset($item->viewBag['visibleIfLoggedIn']) || !($item->viewBag['visibleIfLoggedIn'] == '1' && !$user);
                    $notLoggedIn = !isset($item->viewBag['visibleIfNotLoggedIn']) || !($item->viewBag['visibleIfNotLoggedIn'] == '1' && $user);
                    if ($item->items) {
